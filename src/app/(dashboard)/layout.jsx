...
export default function DashboardLayout({ children }) {
  ...
  return (
    <div className="relative min-h-screen w-full flex bg-black overflow-hidden">
      ...
      <div className="xl:hidden fixed top-0 left-0 w-full z-40 flex items-center justify-between p-4 bg-black/40 backdrop-blur-md border-b border-white/5 min-w-[320px]">
      ...
      {/* Main Content Area */}
      <main className="relative z-20 flex flex-1 mt-20 xl:mt-0 ml-0 xl:ml-80 min-h-screen p-4 sm:p-4 overflow-x-auto">
